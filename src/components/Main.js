    ...
    <>
          ...
          <div className="row">
            <div className="col-sm teg-name">
              ...
              <p className="text-start">Discover our online & offline courses in app/web/game
                ...
                details & offers.</p>
              <button className="btn btn-outline-success"><a className="text-decoration-none" href="">ENQUIRY FORM</a></button>
            </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-sm img-col">
              ...
              <button className="btn btn-outline-success mt-2"><a className="text-decoration-none" href="">Read More</a></button>
            </div>
            <div className="col-sm text-center">
        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-sm fourth-three text-center">
              ...
              <img className="position-relative" src="images/dct_web_design_1.png" alt="" />
              <div className="hover-courses border">
                ...
                <a href=""><img src="images/arrow-course.png" width="30px" alt="" /></a>
              </div>
            </div>
            <div className="col-sm fourth-three text-center">
              <b className="position-absolute text-light m-4">Development</b>
              <img src="images/dct_development.png" height="420px" width="100%" alt="" />
              <img className="position-relative" src="images/dcr_courses_design.png" alt="" />
              <div className="hover-courses border">
                <b className="position-absolute text-light m-4">Development</b>
                <p>Documents, images, videos,
                  applications, and more, stored
      ...
      <section className="fifth-section">
        <div className="container text-center">
          ...
          <div className="row">
            <div className="col-sm py-5 bg-white">
              <h1>30+</h1>
...
functionalities, and expected outcomes.</p>
            ...
            <div className="text-center mt-5"><button className="btn btn-outline-success mt-2"><a className="text-decoration-none" href="">Read More</a></button></div>
        </div>
      </section>
...
are executed with precision.</p>
            ...
            <div className="col-sm pt-4">
              <ul>
              <b>Quick Links <hr/></b>
                <li className="list-unstyled mt-3"><a className="text-white list-unstyled text-decoration-none" href="">Home</a></li>
                <li className="list-unstyled"><a className="text-white list-unstyled text-decoration-none" href="">Services</a></li>
                <li className="list-unstyled"><a className="text-white list-unstyled text-decoration-none" href="">About Us</a></li>
                <li className="list-unstyled"><a className="text-white list-unstyled text-decoration-none" href="">Contact Us</a></li>
                <li className="list-unstyled"><a className="text-white list-unstyled text-decoration-none" href="">Enquiry Form</a></li>
              </ul>
            </div>
            <div className="col-sm pt-4">
              <ul>
              <b>Quick Links <hr/></b>
                <li className="list-unstyled mt-3"><a className="text-white list-unstyled text-decoration-none" href="">Coding</a></li>
                <li className="list-unstyled"><a className="text-white list-unstyled text-decoration-none" href="">Hacking</a></li>
                <li className="list-unstyled"><a className="text-white list-unstyled text-decoration-none" href="">Basic</a></li>
                <li className="list-unstyled"><a className="text-white list-unstyled text-decoration-none" href="">College courses</a></li>
              </ul>
            </div>
            <div className="col-sm py-3">
              <b>Address <hr/></b>
...
+919649911993</p>
      ...
      <div className="row links-row">
            ...
            <ul className="d-flex float-start">
                <li className="list-unstyled"><a className="text-white list-unstyled text-decoration-none" href="">Privacy </a>| &nbsp; </li>
                <li className="list-unstyled"><a className="text-white list-unstyled text-decoration-none" href="">Articles </a>| &nbsp;</li>
                <li className="list-unstyled"><a className="text-white list-unstyled text-decoration-none" href="">Sitemap </a></li>
              </ul>
            </div>
            <div className="col-sm py-3">
