...
function EthicalHeacking() {
    ...
    <button type="button" className="btn text-white fw-bold px-4 my-3 mx-3 rounded-pill">FEES: 50,000/- Only</button>
      <p className="pe-5">
        ...
        </div>Delve into the ethical hacking course in Kotputli, where cybersecurity meets cutting-edge digital computer technology. Learn penetration testing, network security, and ethical hacking techniques essential for safeguarding digital assets. Perfect for IT professionals and enthusiasts in Kotputli aiming to enhance their cybersecurity skills. Gain hands-on experience with tools like Kali Linux in simulated environments. Enroll today to become proficient in ethical hacking and protect against digital threats in Kotputli’s rapidly advancing technological landscape.</p>
    </div>
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item" data-bs-interval="2000">
      <img src="./images/digital_computer_technology_kotputli_course_Ethical-hacking-slide4.jpg" class="d-block w-100" height={"465px"} alt="..."/>
    </div>
    <div class="carousel-item">
      <img src="./images/digital_computer_technology_kotputli_course_Ethical-hacking-slide3.jpg" class="d-block w-100" height={"465px"} alt="..."/>
    </div>
    <div class="carousel-item">
      <img src="./images/digital_computer_technology_kotputli_course_Ethical-hacking-slide2.jpg" class="d-block w-100" height={"465px"} alt="..."/>
    </div>
  </div>
