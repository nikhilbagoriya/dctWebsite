...
function TallyWithGst() {
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item" data-bs-interval="2000">
      <img src="./images/digital_computer_technology_kotputli_company.jpg" class="d-block w-100" height={"465px"} alt="..."/>
    </div>
    <div class="carousel-item">
      <img src="./images/digital_computer_technology_kotputli_balance_sheet.jpg" class="d-block w-100" height={"465px"} alt="..."/>
    </div>
  </div>
